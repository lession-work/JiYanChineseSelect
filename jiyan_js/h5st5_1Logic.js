...
const jdSecurity = require("./js_security_v3_5_1.js");
...
async function getH5st(h5stParams) {
    ...
    //     "clientVersion": "2.5.2",
    //     "t": 1742488663641,
    //     "body": "8479b2f2b34289b724a9170ff3b07be503c8d3452a58e23f7287158debfa54ab"
    // };    

    console.log("%s开始请求5.1签名 %s ",signAppId,JSON.stringify(J));
...
async function run(){
    var cookieStr = "pt_pin=jd_XGQYXqwZWihW;pt_key=AAJn270DADArHhId-a5vu8pK4FrKDTeFE2BbLobs7vSBa8-8F96AEPKjYd-nK_0WLWdmC2RTB1o;";
